...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            String answerToCheat = new Scanner(System.in).nextLine();

            if (answerToCheat.equalsIgnoreCase("Y")) {
                if (i == 0) {
                    userBone1 = checkChance(1);
                    userBone2 = checkChance(1);
//                    userBone1 = moreChance(predictedNumberUser[i]);
//                    userBone2 = moreChance(predictedNumberUser[i]);
                    if(userBone1 == predictedNumberUser[i] || userBone2 == predictedNumberUser[i]){
                        check = true;
                    }
                } else if (i == 1) {
                    userBone1 = checkChance(2);
                    userBone2 = checkChance(2);
                    if(userBone1 == predictedNumberUser[i] || userBone2 == predictedNumberUser[i]){
                        check = true;
                    }
                } else if (i == 2) {
                    userBone1 = checkChance(3);
                    userBone2 = checkChance(3);
                    if(userBone1 == predictedNumberUser[i] || userBone2 == predictedNumberUser[i]){
                        check = true;
                    }
                }
                ...
                System.out.println(userBone1 + " " + userBone2);
            ...
            } else if (answerToCheat.equals("N")) {
                userBone1 = rollTheDice();
                userBone2 = rollTheDice();
                userSumBones[i] = userBone1 + userBone2;
        ...
        public static int moreChance(int number){
            return random.nextInt(1, number + 1);
        }
        public static int checkChance(int number){
            switch(number){
                case 1: return random.nextInt(1, 3);
                case 2:
